    ...
    <div class="nav-menu">
      ...
      <ul class="nav-list">
        ...
        <ul id="user-functions" class="collapse nav-collapse-list">
          ...
          <li class=""><a href=""><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Panel rozpiski</a></li>
          <li class="blocked"><a ><i class="fa fa-users" aria-hidden="true"></i>Ranking</a></li>
          <li class="blocked"><a ><i class="fa fa-balance-scale" aria-hidden="true"></i>Rozliczenia</a></li>
          ...
          <li class="blocked"><a ><i class="fa fa-address-card" aria-hidden="true"></i>Karta kierowcy</a></li>
          <span></span>
        </ul>
